...
static const yytype_int16 yyrline[] =
{
      ...
      72,    79,    84,    91,   100,   107,   113,   122,   127,   134,
     135,   139,   144,   151,   155,   159,   163,   167,   174,   178,
     182,   186,   190,   194,   201,   205,   209,   213,   217,   221,
     228,   229,   230,   234,   238,   245,   249,   256,   260,   267,
     268,   269,   273,   280,   284,   291,   295,   302,   306,   310,
     317,   318,   322,   323,   327,   331
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "UPDATE", "SET", "DELETE", "INFINITY", "BETWEEN", "TWO",
...
#line 60 "parser.y"
    {
        results[results_ind] = (yyvsp[-1].table);
    }
#line 1516 "y.tab.c"
    break;
...
#line 108 "parser.y"
    {
        ...
        check_err(execute_select(temp, *(yyvsp[0].vec_string), *(yyvsp[-2].vec_string)));
        (yyval.table) = temp;
    }
#line 1569 "y.tab.c"
    break;
...
#line 114 "parser.y"
    {
        Temp_table *temp = new Temp_Table();
        check_err(execute_select(temp, *(yyvsp[-2].vec_string), *(yyvsp[-4].vec_string), (yyvsp[0].logast)));
        (yyval.table) = temp;
    }
#line 1579 "y.tab.c"
    break;
...
#line 202 "parser.y"
    {
        (yyval.exprast) = new ExprAST((yyvsp[-2].exprast), (yyvsp[0].exprast), _MULT);
    }
#line 1701 "y.tab.c"
    break;
...
#line 206 "parser.y"
    {
        (yyval.exprast) = new ExprAST((yyvsp[-2].exprast), (yyvsp[0].exprast), _PLUS);
    }
#line 1709 "y.tab.c"
    break;
...
#line 210 "parser.y"
    {
        (yyval.exprast) = new ExprAST((yyvsp[-2].exprast), (yyvsp[0].exprast), _MINUS);
    }
#line 1717 "y.tab.c"
    break;
...
#line 214 "parser.y"
    {
        (yyval.exprast) = new ExprAST((yyvsp[-2].exprast), (yyvsp[0].exprast), _DIV);
    }
#line 1725 "y.tab.c"
    break;
...
#line 250 "parser.y"
    {
        (yyval.vec_col_desc) = new vector<col_desc> (1, (yyvsp[0].col_desc));
    }
#line 1791 "y.tab.c"
    break;
...
#line 257 "parser.y"
    {
        (yyval.col_desc) = new Column_Desc(*(yyvsp[-2].str).c_str(), (yyvsp[-1].int_val), (yyvsp[0].range)->lower_bound, (yyvsp[0].range)->upper_bound);
    }
#line 1799 "y.tab.c"
    break;
...
#line 261 "parser.y"
    {
        (yyval.col_desc) = new Column_Desc(*(yyvsp[-1].str).c_str(), (yyvsp[0].int_val));
    }
#line 1807 "y.tab.c"
    break;
...
#line 1879 "y.tab.c"
  ...
  case 63:
#line 323 "parser.y"
                           {(yyval.update_pair) = new update_pair((yyvsp[-2].str), (yyvsp[0].constant));}
#line 1885 "y.tab.c"
    break;
